...
export const CARDS = {
    ...
    "Pasta AI Overlord": {
        description: "The factory's AI gains sentience and starts issuing orders.",
        requirements: null,
        statModifiers: {
            chaos: 15,
            prestige: 12,
        ...
        effect: (state) => {
            savePlayedCard("Pasta AI Overlord");
            if (state.playerStats.chaosLevel < 40) {
                state.playerStats.pastaPrestige += 8;
                return "The AI optimizes production beyond human capability!";
            }
            return "The AI demands tribute in the form of spaghetti!";
        }
    },

    "Macaroni Meteor Shower": {
        description: "A meteor shower rains macaroni on the city.",
        requirements: null,
        statModifiers: {
            ingredients: 5,
            chaos: 10,
        ...
        effect: (state) => {
            savePlayedCard("Macaroni Meteor Shower");
            return "The meteor shower boosts your ingredient supply and public interest!";
        }
    },

    "Pasta Time Capsule": {
        description: "Unearth a time capsule filled with ancient pasta recipes.",
        requirements: null,
        statModifiers: {
            prestige: 10,
            chaos: -5,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Time Capsule");
            return "The ancient recipes inspire a new wave of pasta innovation!";
        }
    },

    "Spaghetti Supernova": {
        description: "A cosmic event creates a glowing spaghetti nebula.",
        requirements: null,
        statModifiers: {
            prestige: 15,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Spaghetti Supernova");
            return "The glowing nebula attracts tourists and boosts your reputation!";
        }
    },

    "Ravioli Revolution": {
        description: "The stuffed pasta demands equal rights and better working conditions.",
        requirements: null,
        statModifiers: {
            chaos: 12,
            workers: -3,
        ...
        effect: (state) => {
            savePlayedCard("Ravioli Revolution");
            return "The revolution disrupts production, but the workers rally to recover!";
        }
    },

    "Pasta Eclipse": {
        description: "A solar eclipse inspires a pasta-themed festival.",
        requirements: null,
        statModifiers: {
            prestige: 18,
            chaos: 6,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Eclipse");
            return "The festival is a hit, boosting your factory's reputation!";
        }
    },

    "Noodle Nebula Discovery": {
        description: "Astronomers discover a nebula shaped like noodles.",
        requirements: null,
        statModifiers: {
            prestige: 12,
            chaos: 5,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nebula Discovery");
            return "The discovery sparks wonder and boosts your prestige!";
        }
    },

    "Pasta Prophecy Unveiled": {
        description: "A prophecy foretells your factory's rise to greatness.",
        requirements: null,
        statModifiers: {
            chaos: 10,
            prestige: 15,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Prophecy Unveiled");
            return "The prophecy inspires awe and attracts new customers!";
        }
    },

    "Noodle Nirvana Achieved": {
        description: "Achieve a state of perfect harmony in pasta production.",
        requirements: { prestige: 50 },
        statModifiers: {
            prestige: 25,
            chaos: -10,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nirvana Achieved");
            return "Your factory becomes a beacon of pasta perfection!";
        }
    },

    "Pasta Pilgrimage Expanded": {
        description: "Expand the pilgrimage to include new pasta landmarks.",
        requirements: { prestige: 40 },
        statModifiers: {
            prestige: 20,
            chaos: -8,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Pilgrimage Expanded");
            return "The expanded pilgrimage attracts visitors from around the world!";
        }
    },
    ...
    "Pasta Power Surge": {
        description: "Harness the power of pasta to generate renewable energy.",
        requirements: { prestige: 45 },
        statModifiers: {
            prestige: 20,
            chaos: -10,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Power Surge");
            return "The power surge boosts your factory's efficiency!";
        }
    },

    "Pasta Preservation Initiative": {
        description: "Launch an initiative to preserve pasta culture worldwide.",
        requirements: { prestige: 35 },
        statModifiers: {
            prestige: 15,
            chaos: -8,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Preservation Initiative");
            return "The initiative ensures pasta's legacy for future generations!";
        }
    },

    "Cosmic Pasta Alignment": {
        description: "The planets align, forming a pasta-shaped constellation.",
        requirements: null,
        statModifiers: {
            prestige: 20,
            chaos: 10,
        ...
        effect: (state) => {
            savePlayedCard("Cosmic Pasta Alignment");
            return "The cosmic event attracts tourists and boosts your reputation!";
        }
    },

    "Pasta Utopia": {
        description: "Transform your factory into a worker-friendly pasta utopia.",
        requirements: { prestige: 50 },
        statModifiers: {
            workers: 10,
            prestige: 25,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Utopia");
            return "The factory becomes a model of pasta perfection and worker happiness!";
        }
    },

    "Infinite Spaghetti Loop": {
        description: "A glitch in the production line creates an infinite loop of spaghetti.",
        requirements: null,
        statModifiers: {
            chaos: 15,
            prestige: 10,
        ...
        effect: (state) => {
            savePlayedCard("Infinite Spaghetti Loop");
            return "The infinite loop becomes a tourist attraction, boosting your prestige!";
        }
    },

    "Pasta AI Revolution": {
        description: "The factory's AI takes over, optimizing production beyond human capability.",
        requirements: null,
        statModifiers: {
            chaos: 20,
            prestige: 15,
        ...
        effect: (state) => {
            savePlayedCard("Pasta AI Revolution");
            return "The AI revolutionizes pasta production, but at what cost?";
        }
    },

    "Ravioli Renaissance": {
        description: "A cultural movement celebrates the art of stuffed pasta.",
        requirements: { prestige: 30 },
        statModifiers: {
            prestige: 20,
            chaos: -5,
        ...
        effect: (state) => {
            savePlayedCard("Ravioli Renaissance");
            return "The renaissance attracts artists and food critics to your factory!";
        }
    },

    "Pasta Festival of Lights": {
        description: "Illuminate the factory with pasta-shaped lanterns for a festival.",
        requirements: null,
        statModifiers: {
            prestige: 15,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Festival of Lights");
            return "The festival attracts crowds and boosts your reputation!";
        }
    },

    "Noodle Nexus Expansion": {
        description: "Upgrade your factory to become the ultimate pasta destination.",
        requirements: { prestige: 70 },
        statModifiers: {
            prestige: 40,
            chaos: -15,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nexus Expansion");
            return "Your factory becomes the center of the pasta universe!";
        }
    },

    "Pasta Prophecy Fulfilled": {
        description: "Realize the destiny foretold by the pasta prophecy.",
        requirements: { prestige: 60 },
        statModifiers: {
            prestige: 30,
            chaos: -12,
    ...
    "Spaghetti Singularity": {
        description: "A singularity forms in the pasta production line.",
        requirements: null,
        statModifiers: {
            chaos: 18,
            prestige: 12,
        ...
        effect: (state) => {
            savePlayedCard("Spaghetti Singularity");
            return "The singularity attracts scientists and boosts your reputation!";
        }
    },

    "Pasta Planetarium Upgrade": {
        description: "Enhance the planetarium with advanced pasta-shaped constellations.",
        requirements: { prestige: 50 },
        statModifiers: {
            prestige: 25,
            chaos: -10,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Planetarium Upgrade");
            return "The upgraded planetarium attracts even more visitors!";
        }
    },

    "Cosmic Pasta Expansion": {
        description: "Explore new cosmic pasta phenomena.",
        requirements: { prestige: 85 },
        statModifiers: {
            prestige: 50,
        ...
        effect: (state) => {
            savePlayedCard("Cosmic Pasta Expansion");
            return "The expansion unlocks new cosmic pasta possibilities!";
        }
    },
    ...
    "Farfalle Festival": {
        description: "Celebrate the versatility of bow-tie pasta with a factory-wide event.",
        requirements: null,
        statModifiers: {
            prestige: 10,
            chaos: 5,
        ...
        effect: (state) => {
            savePlayedCard("Farfalle Festival");
            return "The festival attracts pasta enthusiasts and boosts morale!";
        }
    },

    "Pasta Poetry Contest": {
        description: "Workers compete to write the best pasta-themed poetry.",
        requirements: null,
        statModifiers: {
            prestige: 6,
            chaos: -4,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Poetry Contest");
            return "The winning poem becomes a viral sensation, boosting your reputation!";
        }
    },

    "Ravioli Research Lab": {
        description: "Open a lab dedicated to innovating new ravioli fillings.",
        requirements: { ingredients: 2 },
        statModifiers: {
            prestige: 12,
            chaos: 6,
        ...
        effect: (state) => {
            savePlayedCard("Ravioli Research Lab");
            return "The lab produces groundbreaking ravioli recipes that attract food critics!";
        }
    },

    "Spaghetti Sculpture Contest": {
        description: "Host a competition to create sculptures using spaghetti.",
        requirements: null,
        statModifiers: {
            prestige: 8,
            chaos: 4,
        ...
        effect: (state) => {
            savePlayedCard("Spaghetti Sculpture Contest");
            return "The sculptures draw crowds and media attention to your factory!";
        }
    },

    "Pasta Time Warp": {
        description: "A mysterious event causes time to flow differently in the factory.",
        requirements: null,
        statModifiers: {
            chaos: 12,
            prestige: 10,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Time Warp");
            return "Time anomalies create chaos, but also inspire innovative pasta designs!";
        }
    },

    "Noodle Olympics": {
        description: "Organize a series of pasta-themed athletic events.",
        requirements: null,
        statModifiers: {
            prestige: 15,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Olympics");
            return "The events boost morale and attract international attention!";
        }
    },

    "Pasta Art Museum": {
        description: "Convert part of the factory into a museum showcasing pasta art.",
        requirements: { prestige: 20 },
        statModifiers: {
            prestige: 18,
            chaos: -5,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Art Museum");
            return "The museum becomes a cultural landmark, boosting your reputation!";
        }
    },

    "Linguine Lightning": {
        description: "A freak lightning storm electrifies the factory's linguine supply.",
        requirements: null,
        statModifiers: {
            chaos: 14,
            prestige: 10,
        ...
        effect: (state) => {
            savePlayedCard("Linguine Lightning");
            return "The electrified linguine becomes a viral sensation, boosting sales!";
        }
    },

    "Pasta Parade Float": {
        description: "Design a giant pasta-themed float for the city parade.",
        requirements: { ingredients: 1 },
        statModifiers: {
            prestige: 12,
            chaos: 6,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Parade Float");
            return "The float wins first prize, attracting new customers to your factory!";
        }
    },

    "Macaroni Maze": {
        description: "Build a maze out of macaroni boxes to entertain visitors.",
        requirements: null,
        statModifiers: {
            prestige: 10,
            chaos: 5,
        ...
        effect: (state) => {
            savePlayedCard("Macaroni Maze");
            return "The maze becomes a popular attraction, boosting your factory's reputation!";
        }
    },

    "Pasta Propaganda Machine": {
        description: "Install a machine that broadcasts pasta-themed advertisements.",
        requirements: { prestige: 15 },
        statModifiers: {
            prestige: 20,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Propaganda Machine");
            return "The advertisements attract a wave of new customers!";
        }
    },

    "Noodle Nostalgia Night": {
        description: "Host a nostalgic event featuring classic pasta dishes.",
        requirements: null,
        statModifiers: {
            prestige: 12,
            chaos: -6,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nostalgia Night");
            return "The event rekindles fond memories and boosts your factory's reputation!";
        }
    },

    "Pasta Puzzle Championship": {
        description: "Organize a competition to solve pasta-themed puzzles.",
        requirements: null,
        statModifiers: {
            prestige: 8,
            chaos: -4,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Puzzle Championship");
            return "The championship attracts puzzle enthusiasts and boosts morale!";
        }
    },

    "Spaghetti Supercomputer": {
        description: "Build a supercomputer powered by spaghetti logic.",
        requirements: { ingredients: 2 },
        statModifiers: {
            prestige: 15,
            chaos: 10,
        ...
        effect: (state) => {
            savePlayedCard("Spaghetti Supercomputer");
            return "The supercomputer solves complex problems and attracts media attention!";
        }
    },

    "Ravioli Rescue Mission": {
        description: "Save a shipment of ravioli from a sinking delivery truck.",
        requirements: null,
        statModifiers: {
            chaos: 8,
            prestige: 10,
        ...
        effect: (state) => {
            savePlayedCard("Ravioli Rescue Mission");
            return "The heroic rescue becomes a viral story, boosting your reputation!";
        }
    },

    "Pasta Planet Discovery": {
        description: "Astronomers discover a planet made entirely of pasta.",
        requirements: null,
        statModifiers: {
            prestige: 20,
            chaos: 10,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Planet Discovery");
            return "The discovery sparks global interest in your factory!";
        }
    },

    "Noodle Nebula Telescope": {
        description: "Build a telescope to study the noodle-shaped nebula.",
        requirements: { ingredients: 3 },
        statModifiers: {
            prestige: 18,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nebula Telescope");
            return "The telescope attracts scientists and boosts your factory's reputation!";
        }
    },

    "Pasta Preservation Vault": {
        description: "Create a vault to preserve rare pasta shapes for future generations.",
        requirements: { prestige: 25 },
        statModifiers: {
            prestige: 20,
            chaos: -8,
        ...
        effect: (state) => {
            savePlayedCard("Pasta Preservation Vault");
            return "The vault becomes a symbol of your factory's commitment to pasta culture!";
        }
    },

    "Spaghetti Space Program": {
        description: "Launch a rocket powered by spaghetti fuel.",
        requirements: { ingredients: 5 },
        statModifiers: {
            prestige: 25,
            chaos: 15,
            ingredients: -5
        ...
        effect: (state) => {
            ...
            return "The rocket's success puts your factory on the global stage!";
        }
    },

    "Ravioli Renaissance Fair": {
        description: "Host a medieval-themed fair celebrating ravioli.",
        requirements: null,
        statModifiers: {
            prestige: 15,
            chaos: 8,
        ...
        effect: (state) => {
            savePlayedCard("Ravioli Renaissance Fair");
            return "The fair attracts crowds and boosts your factory's reputation!";
        }
    },

    "Pasta AI Singularity": {
        description: "The factory's AI achieves singularity and starts creating pasta art.",
        requirements: null,
        statModifiers: {
            chaos: 18,
            prestige: 15,
        ...
        effect: (state) => {
            savePlayedCard("Pasta AI Singularity");
            return "The AI's pasta art becomes a global sensation, boosting your reputation!";
        }
    },

    "Noodle Nostradamus Prophecy": {
        description: "A prophecy predicts your factory's rise to global dominance.",
        requirements: null,
        statModifiers: {
            chaos: 12,
            prestige: 20,
        ...
        effect: (state) => {
            savePlayedCard("Noodle Nostradamus Prophecy");
            return "The prophecy inspires awe and attracts new customers!";
        }
    },
