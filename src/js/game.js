...
const TOOLTIPS = [
    ...
    "A plus sign (<span class=\"positive\">+</span>) generally means a positive effect for your factory.",
    "A plus sign (<span class=\"positive\">+</span>) is good.",
    "A minus sign (<span class=\"negative\">-</span>) is bad.",
    "The number of plus (<span class=\"positive\">+</span>) or minus (<span class=\"negative\">-</span>) signs indicates the strength of the effect.",
    "The minus sign (<span class=\"negative\">-</span>) usually indicates a negative effect on your factory.",
